...
bitbake apps-imgsrv -c cleansstate
bitbake apps-imgsrv -c unpack -f
bitbake apps-imgsrv -c configure -f
./used_files.py sysroots -1
bitbake apps-imgsrv -c compile -f
./used_files.py sysroots 1473297567.42 (actual reported timestamp from previous run)
